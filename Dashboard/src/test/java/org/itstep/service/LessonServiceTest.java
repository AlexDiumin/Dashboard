...
public class LessonServiceTest {
	...
	public void testGetAllLessons() {
		...
		lesson.setDescription(" ");
		Lesson lessonDB = lessonServiceImpl.saveAndUpdate(lesson);
		List<Lesson> lessonsDB = lessonServiceImpl.getAllLessons();
		assertNotNull(lessonsDB);
		assertEquals(lessonsDB.get(lessonsDB.size()-1).getLessonId(),lessonDB.getLessonId());
		lessonServiceImpl.delete(lessonDB.getLessonId());
	}
