...
public class GroupControllerTest {
	...
	public void getAllGroupsTest(){
		...
		String groupsJsonObject = gson.toJson(groups);
		
		RequestEntity<String> reqEntity = null;
		try {
			reqEntity = new RequestEntity<String>(groupsJsonObject, HttpMethod.GET, new URI("/group/get-all"));
		} catch (URISyntaxException e) {
			e.printStackTrace();
		}
		ResponseEntity<String> respEntity = testRestTemplate.exchange(reqEntity, String.class);
		...
		Mockito.verify(groupService, Mockito.times(1)).getAllGroups();
	}
